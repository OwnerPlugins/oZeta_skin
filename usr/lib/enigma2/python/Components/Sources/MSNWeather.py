...
class MSNWeather(Source):
    ...
    def getTemperature_Heigh(self, key):
        ...
        if skey in weathermsn.weatherData.weatherItems:
            ...
            highTemp = item.high
            return "%s%s%s" % (
                highTemp, SIGN, weathermsn.weatherData.degreetype)
        else:
            return _("n/a")
    ...
    def getTemperature_Low(self, key):
        ...
        if skey in weathermsn.weatherData.weatherItems:
            ...
            lowTemp = item.low
            return "%s%s%s" % (
                lowTemp, SIGN, weathermsn.weatherData.degreetype)
        else:
            return _("n/a")
    ...
    def getTemperature_Current(self):
        ...
        if skey in weathermsn.weatherData.weatherItems:
            return "%s%s%s" % (
                weathermsn.weatherData.weatherItems[skey].temperature, SIGN, weathermsn.weatherData.degreetype)
        else:
            return _("n/a")
